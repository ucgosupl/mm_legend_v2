...
# File:     conf.mk
# Author:   GAndaLF
# Brief:    Makefile configuration script for hw_test_motor_linear target.
#
# This file contains configuration variables for hw_test_motor_linear target.
# After setting these variables, actual build script is called.
################################################################################

# Name for output files.
TARGET_NAME := hw_test_motor_linear
