...
static void wall_test_task(void *params)
{
    ...
    while (1)
    {
        front_l = wall_sensor_front_l_dist_mm_get();
        front_r = wall_sensor_front_r_dist_mm_get();
        diag_l = wall_sensor_diag_l_dist_mm_get();
        diag_r = wall_sensor_diag_r_dist_mm_get();
        side_l = wall_sensor_side_l_dist_mm_get();
        side_r = wall_sensor_side_r_dist_mm_get();
