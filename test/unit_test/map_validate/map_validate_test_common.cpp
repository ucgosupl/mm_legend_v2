...
TEST(map_validate_common, LeftIfAbsentAfterAdjacentPresentResetCounter)
{
    int32_t i;
    ...
    map_validate_wall_left(REGULAR_CELL, MAP_WALL_ABSENT);
    map_validate_wall_right(map_cell_adjacent_to_wall_left_get(REGULAR_CELL), MAP_WALL_PRESENT);
...
TEST(map_validate_common, LeftIfPresentAfterAdjacentAbsentResetCounter)
{
    int32_t i;
...
TEST(map_validate_common, RightIfAbsentAfterAdjacentPresentResetCounter)
{
    int32_t i;
    ...
    map_validate_wall_right(REGULAR_CELL, MAP_WALL_ABSENT);
    map_validate_wall_left(map_cell_adjacent_to_wall_right_get(REGULAR_CELL), MAP_WALL_PRESENT);
...
TEST(map_validate_common, RightIfPresentAfterAdjacentAbsentResetCounter)
{
    int32_t i;
...
TEST(map_validate_common, TopIfAbsentAfterAdjacentPresentResetCounter)
{
    int32_t i;
    ...
    map_validate_wall_top(REGULAR_CELL, MAP_WALL_ABSENT);
    map_validate_wall_bottom(map_cell_adjacent_to_wall_top_get(REGULAR_CELL), MAP_WALL_PRESENT);
...
TEST(map_validate_common, TopIfPresentAfterAdjacentAbsentResetCounter)
{
    int32_t i;
...
TEST(map_validate_common, BottomIfAbsentAfterAdjacentPresentResetCounter)
{
    int32_t i;
    ...
    map_validate_wall_bottom(REGULAR_CELL, MAP_WALL_ABSENT);
    map_validate_wall_top(map_cell_adjacent_to_wall_bottom_get(REGULAR_CELL), MAP_WALL_PRESENT);
...
TEST(map_validate_common, BottomIfPresentAfterAdjacentAbsentResetCounter)
{
    int32_t i;
