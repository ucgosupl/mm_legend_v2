...
# File:     conf.mk
# Author:   GAndaLF
# Brief:    Makefile configuration script for unit_test_map_update target.
#
# This file contains configuration variables for unit_test_map_update target.
# After setting these variables, actual build script is called.
################################################################################

# Name for output binary hex, bin files
TARGET_NAME := map_update
